...
$(function() {
	$('.introduction path').each(function() {
...
$(function() {
	var timer;
	$('.page-galaxy .stores .core > ul li').on('mouseover', function() {
		var t = $(this).find('path');
		function starsScale() {
			t.each(function() {
				$(this).velocity({
	...
	$('.page-galaxy .stores .core > ul li').on('mouseout', function() {
